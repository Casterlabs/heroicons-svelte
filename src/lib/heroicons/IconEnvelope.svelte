<script lang="ts">
	...
	export const NAME = `IconEnvelope`;

	const SVGS: Record<IconTheme, string> = {
		outline: `<svg data-type="svelte-heroicons" data-icon="IconEnvelope" data-theme="outline" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		solid: `<svg data-type="svelte-heroicons" data-icon="IconEnvelope" data-theme="solid" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		mini: `<svg data-type="svelte-heroicons" data-icon="IconEnvelope" data-theme="mini" aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		micro: `<svg data-type="svelte-heroicons" data-icon="IconEnvelope" data-theme="micro" aria-hidden="true" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M2.5 3C1.67157 3 1 3.67157 1 4.5V5.29294C1.02568 5.30204 1.05113 5.31264 1.07623 5.32476L7.67411 8.50994C7.88011 8.60939 8.12023 8.60939 8.32623 8.50994L14.9241 5.32476C14.9491 5.31269 14.9744 5.30214 15 5.29306V4.5C15 3.67157 14.3284 3 13.5 3H2.5Z" fill="currentColor"/>
<path d="M15 6.95377L8.97836 9.86077C8.36036 10.1591 7.63999 10.1591 7.02199 9.86077L1 6.9536V11.5C1 12.3284 1.67157 13 2.5 13H13.5C14.3284 13 15 12.3284 15 11.5V6.95377Z" fill="currentColor"/>
</svg>
`
	};
</script>

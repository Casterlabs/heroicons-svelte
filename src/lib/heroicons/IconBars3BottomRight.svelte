<script lang="ts">
	...
	export const NAME = `IconBars3BottomRight`;

	const SVGS: Record<IconTheme, string> = {
		outline: `<svg data-type="svelte-heroicons" data-icon="IconBars3BottomRight" data-theme="outline" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		solid: `<svg data-type="svelte-heroicons" data-icon="IconBars3BottomRight" data-theme="solid" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		mini: `<svg data-type="svelte-heroicons" data-icon="IconBars3BottomRight" data-theme="mini" aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		micro: `<svg data-type="svelte-heroicons" data-icon="IconBars3BottomRight" data-theme="micro" aria-hidden="true" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">

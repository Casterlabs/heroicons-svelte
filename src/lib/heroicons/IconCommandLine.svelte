<script lang="ts">
	...
	export const NAME = `IconCommandLine`;

	const SVGS: Record<IconTheme, string> = {
		outline: `<svg data-type="svelte-heroicons" data-icon="IconCommandLine" data-theme="outline" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		solid: `<svg data-type="svelte-heroicons" data-icon="IconCommandLine" data-theme="solid" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		mini: `<svg data-type="svelte-heroicons" data-icon="IconCommandLine" data-theme="mini" aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		micro: `<svg data-type="svelte-heroicons" data-icon="IconCommandLine" data-theme="micro" aria-hidden="true" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M2 4C2 2.89543 2.89543 2 4 2H12C13.1046 2 14 2.89543 14 4V12C14 13.1046 13.1046 14 12 14H4C2.89543 14 2 13.1046 2 12V4ZM4.21967 5.96967C3.92678 6.26256 3.92678 6.73744 4.21967 7.03033L5.18934 8L4.21967 8.96967C3.92678 9.26256 3.92678 9.73744 4.21967 10.0303C4.51256 10.3232 4.98744 10.3232 5.28033 10.0303L6.78033 8.53033C7.07322 8.23744 7.07322 7.76256 6.78033 7.46967L5.28033 5.96967C4.98744 5.67678 4.51256 5.67678 4.21967 5.96967ZM8.75 8.5C8.33579 8.5 8 8.83579 8 9.25C8 9.66421 8.33579 10 8.75 10H11.25C11.6642 10 12 9.66421 12 9.25C12 8.83579 11.6642 8.5 11.25 8.5H8.75Z" fill="currentColor"/>
</svg>
`
	};
</script>

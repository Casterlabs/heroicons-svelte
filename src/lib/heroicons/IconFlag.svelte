<script lang="ts">
	...
	export const NAME = `IconFlag`;

	const SVGS: Record<IconTheme, string> = {
		outline: `<svg data-type="svelte-heroicons" data-icon="IconFlag" data-theme="outline" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		solid: `<svg data-type="svelte-heroicons" data-icon="IconFlag" data-theme="solid" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		mini: `<svg data-type="svelte-heroicons" data-icon="IconFlag" data-theme="mini" aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		micro: `<svg data-type="svelte-heroicons" data-icon="IconFlag" data-theme="micro" aria-hidden="true" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M2.75 2C2.33579 2 2 2.33579 2 2.75V13.25C2 13.6642 2.33579 14 2.75 14C3.16421 14 3.5 13.6642 3.5 13.25V10.6255L3.83069 10.5428C5.23054 10.1928 6.7094 10.3552 8 11.0005C9.2906 11.6458 10.7695 11.8081 12.1693 11.4581L13.6498 11.088C13.8556 11.0366 14 10.8517 14 10.6395V3.56111C14 3.27633 13.7324 3.06737 13.4561 3.13644L12.1693 3.45814C10.7695 3.8081 9.2906 3.64576 8 3.00046C6.7094 2.35517 5.23054 2.19283 3.8307 2.54279L3.49012 2.62794C3.43182 2.27178 3.12265 2 2.75 2Z" fill="currentColor"/>
</svg>
`
	};
</script>

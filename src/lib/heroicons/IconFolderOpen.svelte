<script lang="ts">
	...
	export const NAME = `IconFolderOpen`;

	const SVGS: Record<IconTheme, string> = {
		outline: `<svg data-type="svelte-heroicons" data-icon="IconFolderOpen" data-theme="outline" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		solid: `<svg data-type="svelte-heroicons" data-icon="IconFolderOpen" data-theme="solid" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		mini: `<svg data-type="svelte-heroicons" data-icon="IconFolderOpen" data-theme="mini" aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		micro: `<svg data-type="svelte-heroicons" data-icon="IconFolderOpen" data-theme="micro" aria-hidden="true" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M3 3.5C3 2.67157 3.67157 2 4.5 2H6.37868C6.7765 2 7.15804 2.15804 7.43934 2.43934L8.56066 3.56066C8.84196 3.84197 9.2235 4 9.62132 4H11.5C12.3284 4 13 4.67157 13 5.5V6.5H3V3.5Z" fill="currentColor"/>
<path d="M3.08123 8C2.05739 8 1.33444 9.00305 1.6582 9.97434L2.6582 12.9743C2.86237 13.5869 3.43558 14 4.08123 14H11.919C12.5646 14 13.1378 13.5869 13.342 12.9743L14.342 9.97434C14.6657 9.00305 13.9428 8 12.919 8H3.08123Z" fill="currentColor"/>
</svg>
`
	};
</script>

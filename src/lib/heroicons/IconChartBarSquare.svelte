<script lang="ts">
	...
	export const NAME = `IconChartBarSquare`;

	const SVGS: Record<IconTheme, string> = {
		outline: `<svg data-type="svelte-heroicons" data-icon="IconChartBarSquare" data-theme="outline" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		solid: `<svg data-type="svelte-heroicons" data-icon="IconChartBarSquare" data-theme="solid" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		mini: `<svg data-type="svelte-heroicons" data-icon="IconChartBarSquare" data-theme="mini" aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		micro: `<svg data-type="svelte-heroicons" data-icon="IconChartBarSquare" data-theme="micro" aria-hidden="true" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M4 2C2.89543 2 2 2.89543 2 4V12C2 13.1046 2.89543 14 4 14H12C13.1046 14 14 13.1046 14 12V4C14 2.89543 13.1046 2 12 2H4ZM4.75 9C4.33579 9 4 9.33579 4 9.75V11.25C4 11.6642 4.33579 12 4.75 12C5.16421 12 5.5 11.6642 5.5 11.25V9.75C5.5 9.33579 5.16421 9 4.75 9ZM7.25 7.25C7.25 6.83579 7.58579 6.5 8 6.5C8.41421 6.5 8.75 6.83579 8.75 7.25V11.25C8.75 11.6642 8.41421 12 8 12C7.58579 12 7.25 11.6642 7.25 11.25V7.25ZM11.25 4C10.8358 4 10.5 4.33579 10.5 4.75V11.25C10.5 11.6642 10.8358 12 11.25 12C11.6642 12 12 11.6642 12 11.25V4.75C12 4.33579 11.6642 4 11.25 4Z" fill="currentColor"/>
</svg>
`
	};
</script>

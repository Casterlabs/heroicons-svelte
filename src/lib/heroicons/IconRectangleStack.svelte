<script lang="ts">
	...
	export const NAME = `IconRectangleStack`;

	const SVGS: Record<IconTheme, string> = {
		outline: `<svg data-type="svelte-heroicons" data-icon="IconRectangleStack" data-theme="outline" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		solid: `<svg data-type="svelte-heroicons" data-icon="IconRectangleStack" data-theme="solid" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M5.56641 4.65724C5.9435 4.55472 6.34029 4.5 6.74986 4.5H17.2499C17.6594 4.5 18.0562 4.55472 18.4333 4.65724C17.9406 3.67454 16.924 3 15.7499 3H8.24986C7.0757 3 6.0591 3.67454 5.56641 4.65724Z" fill="currentColor"/>
...
`,
		mini: `<svg data-type="svelte-heroicons" data-icon="IconRectangleStack" data-theme="mini" aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		micro: `<svg data-type="svelte-heroicons" data-icon="IconRectangleStack" data-theme="micro" aria-hidden="true" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M5 3.5C5 2.67157 5.67157 2 6.5 2H9.5C10.3284 2 11 2.67157 11 3.5H5Z" fill="currentColor"/>
<path d="M4.5 5C3.67157 5 3 5.67157 3 6.5V6.54148C3.1626 6.5142 3.32964 6.5 3.5 6.5H12.5C12.6704 6.5 12.8374 6.5142 13 6.54148V6.5C13 5.67157 12.3284 5 11.5 5H4.5Z" fill="currentColor"/>
<path d="M12.5 8H3.5C2.67157 8 2 8.67157 2 9.5V12.5C2 13.3284 2.67157 14 3.5 14H12.5C13.3284 14 14 13.3284 14 12.5V9.5C14 8.67157 13.3284 8 12.5 8Z" fill="currentColor"/>
</svg>
`
	};
</script>

<script lang="ts">
	...
	export const NAME = `IconMagnifyingGlassPlus`;

	const SVGS: Record<IconTheme, string> = {
		outline: `<svg data-type="svelte-heroicons" data-icon="IconMagnifyingGlassPlus" data-theme="outline" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		solid: `<svg data-type="svelte-heroicons" data-icon="IconMagnifyingGlassPlus" data-theme="solid" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		mini: `<svg data-type="svelte-heroicons" data-icon="IconMagnifyingGlassPlus" data-theme="mini" aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		micro: `<svg data-type="svelte-heroicons" data-icon="IconMagnifyingGlassPlus" data-theme="micro" aria-hidden="true" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M6.25 8.75V7.75H5.25C4.83579 7.75 4.5 7.41421 4.5 7C4.5 6.58579 4.83579 6.25 5.25 6.25L6.25 6.25V5.25C6.25 4.83579 6.58579 4.5 7 4.5C7.41421 4.5 7.75 4.83579 7.75 5.25V6.25H8.75C9.16421 6.25 9.5 6.58579 9.5 7C9.5 7.41421 9.16421 7.75 8.75 7.75H7.75V8.75C7.75 9.16421 7.41421 9.5 7 9.5C6.58579 9.5 6.25 9.16421 6.25 8.75Z" fill="currentColor"/>

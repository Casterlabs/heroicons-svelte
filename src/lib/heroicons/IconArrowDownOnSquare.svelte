<script lang="ts">
	...
	export const NAME = `IconArrowDownOnSquare`;

	const SVGS: Record<IconTheme, string> = {
		outline: `<svg data-type="svelte-heroicons" data-icon="IconArrowDownOnSquare" data-theme="outline" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		solid: `<svg data-type="svelte-heroicons" data-icon="IconArrowDownOnSquare" data-theme="solid" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M12 1.5C12.4142 1.5 12.75 1.83579 12.75 2.25L12.75 7.5H11.25V2.25C11.25 1.83579 11.5858 1.5 12 1.5Z" fill="currentColor"/>
...
`,
		mini: `<svg data-type="svelte-heroicons" data-icon="IconArrowDownOnSquare" data-theme="mini" aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		micro: `<svg data-type="svelte-heroicons" data-icon="IconArrowDownOnSquare" data-theme="micro" aria-hidden="true" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M8 1C8.41421 1 8.75 1.33579 8.75 1.75V5H7.25V1.75C7.25 1.33579 7.58579 1 8 1Z" fill="currentColor"/>

<script lang="ts">
	...
	export const NAME = `IconArrowUturnUp`;

	const SVGS: Record<IconTheme, string> = {
		outline: `<svg data-type="svelte-heroicons" data-icon="IconArrowUturnUp" data-theme="outline" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M9 9L15 3M15 3L21 9M15 3L15 15C15 18.3137 12.3137 21 9 21C5.68629 21 3 18.3137 3 15L3 12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`,
		solid: `<svg data-type="svelte-heroicons" data-icon="IconArrowUturnUp" data-theme="solid" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		mini: `<svg data-type="svelte-heroicons" data-icon="IconArrowUturnUp" data-theme="mini" aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		micro: `<svg data-type="svelte-heroicons" data-icon="IconArrowUturnUp" data-theme="micro" aria-hidden="true" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M6.25 12.5C7.76878 12.5 9 11.2688 9 9.75L9 4.56066L6.78033 6.78033C6.48744 7.07322 6.01256 7.07322 5.71967 6.78033C5.42678 6.48744 5.42678 6.01256 5.71967 5.71967L9.21967 2.21967C9.51256 1.92678 9.98744 1.92678 10.2803 2.21967L13.7803 5.71967C14.0732 6.01256 14.0732 6.48744 13.7803 6.78033C13.4874 7.07322 13.0126 7.07322 12.7197 6.78033L10.5 4.56066V9.75C10.5 12.0972 8.59721 14 6.25 14C3.90279 14 2 12.0972 2 9.75L2 8.75C2 8.33579 2.33579 8 2.75 8C3.16421 8 3.5 8.33579 3.5 8.75L3.5 9.75C3.5 11.2688 4.73122 12.5 6.25 12.5Z" fill="currentColor"/>
</svg>
`
	};
</script>

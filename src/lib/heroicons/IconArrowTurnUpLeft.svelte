<script lang="ts">
	...
	export const NAME = `IconArrowTurnUpLeft`;

	const SVGS: Record<IconTheme, string> = {
		outline: `<svg data-type="svelte-heroicons" data-icon="IconArrowTurnUpLeft" data-theme="outline" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		solid: `<svg data-type="svelte-heroicons" data-icon="IconArrowTurnUpLeft" data-theme="solid" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		mini: `<svg data-type="svelte-heroicons" data-icon="IconArrowTurnUpLeft" data-theme="mini" aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M16.25 17C15.8358 17 15.5 16.6642 15.5 16.25V8.75H4.56066L6.53033 10.7197C6.82322 11.0126 6.82322 11.4874 6.53033 11.7803C6.23744 12.0732 5.76256 12.0732 5.46967 11.7803L2.21967 8.53033C1.92678 8.23744 1.92678 7.76256 2.21967 7.46967L5.46967 4.21967C5.76256 3.92678 6.23744 3.92678 6.53033 4.21967C6.82322 4.51256 6.82322 4.98744 6.53033 5.28033L4.56066 7.25H16.25C16.6642 7.25 17 7.58579 17 8V16.25C17 16.6642 16.6642 17 16.25 17Z" fill="currentColor"/>
</svg>
`,
		micro: `<svg data-type="svelte-heroicons" data-icon="IconArrowTurnUpLeft" data-theme="micro" aria-hidden="true" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M13.25 14C12.8358 14 12.5 13.6642 12.5 13.25V6.75H4.56066L5.53033 7.71967C5.82322 8.01256 5.82322 8.48744 5.53033 8.78033C5.23744 9.07322 4.76256 9.07322 4.46967 8.78033L2.21967 6.53033C1.92678 6.23744 1.92678 5.76256 2.21967 5.46967L4.46967 3.21967C4.76256 2.92678 5.23744 2.92678 5.53033 3.21967C5.82322 3.51256 5.82322 3.98744 5.53033 4.28033L4.56066 5.25H13.25C13.6642 5.25 14 5.58579 14 6V13.25C14 13.6642 13.6642 14 13.25 14Z" fill="currentColor"/>
</svg>
`
	};
</script>

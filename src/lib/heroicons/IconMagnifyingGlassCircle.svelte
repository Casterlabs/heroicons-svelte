<script lang="ts">
	...
	export const NAME = `IconMagnifyingGlassCircle`;

	const SVGS: Record<IconTheme, string> = {
		outline: `<svg data-type="svelte-heroicons" data-icon="IconMagnifyingGlassCircle" data-theme="outline" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		solid: `<svg data-type="svelte-heroicons" data-icon="IconMagnifyingGlassCircle" data-theme="solid" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M8.25 10.875C8.25 9.42525 9.42525 8.25 10.875 8.25C12.3247 8.25 13.5 9.42525 13.5 10.875C13.5 11.6001 13.207 12.2553 12.7312 12.7312C12.2553 13.207 11.6001 13.5 10.875 13.5C9.42525 13.5 8.25 12.3247 8.25 10.875Z" fill="currentColor"/>
...
`,
		mini: `<svg data-type="svelte-heroicons" data-icon="IconMagnifyingGlassCircle" data-theme="mini" aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		micro: `<svg data-type="svelte-heroicons" data-icon="IconMagnifyingGlassCircle" data-theme="micro" aria-hidden="true" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M5.9393 8.06066C5.35352 7.47487 5.35352 6.52513 5.9393 5.93934C6.52509 5.35355 7.47484 5.35355 8.06063 5.93934C8.64641 6.52513 8.64641 7.47487 8.06063 8.06066C7.47484 8.64645 6.52509 8.64645 5.9393 8.06066Z" fill="currentColor"/>

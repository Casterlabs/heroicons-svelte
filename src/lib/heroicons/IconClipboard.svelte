<script lang="ts">
	...
	export const NAME = `IconClipboard`;

	const SVGS: Record<IconTheme, string> = {
		outline: `<svg data-type="svelte-heroicons" data-icon="IconClipboard" data-theme="outline" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		solid: `<svg data-type="svelte-heroicons" data-icon="IconClipboard" data-theme="solid" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		mini: `<svg data-type="svelte-heroicons" data-icon="IconClipboard" data-theme="mini" aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		micro: `<svg data-type="svelte-heroicons" data-icon="IconClipboard" data-theme="micro" aria-hidden="true" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M10.9863 3H12C13.1046 3 14 3.89543 14 5V13C14 14.1046 13.1046 15 12 15H4C2.89543 15 2 14.1046 2 13V5C2 3.89543 2.89543 3 4 3H5.01373C5.13809 1.87501 6.09186 1 7.25 1H8.75C9.90814 1 10.8619 1.87501 10.9863 3ZM9.5 4V3.25C9.5 2.83579 9.16421 2.5 8.75 2.5H7.25C6.83579 2.5 6.5 2.83579 6.5 3.25V4H9.5Z" fill="currentColor"/>
</svg>
`
	};
</script>

<script lang="ts">
	...
	export const NAME = `IconPaperAirplane`;

	const SVGS: Record<IconTheme, string> = {
		outline: `<svg data-type="svelte-heroicons" data-icon="IconPaperAirplane" data-theme="outline" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M5.99972 12L3.2688 3.12451C9.88393 5.04617 16.0276 8.07601 21.4855 11.9997C16.0276 15.9235 9.884 18.9535 3.26889 20.8752L5.99972 12ZM5.99972 12L13.5 12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`,
		solid: `<svg data-type="svelte-heroicons" data-icon="IconPaperAirplane" data-theme="solid" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		mini: `<svg data-type="svelte-heroicons" data-icon="IconPaperAirplane" data-theme="mini" aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		micro: `<svg data-type="svelte-heroicons" data-icon="IconPaperAirplane" data-theme="micro" aria-hidden="true" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M2.86908 2.29797C2.60248 2.25655 2.33418 2.3615 2.16646 2.57282C1.99873 2.78414 1.95744 3.06927 2.05831 3.31949L3.39039 6.62389C3.54291 7.00223 3.90994 7.25 4.31787 7.25H8.25C8.66421 7.25 9 7.58579 9 8C9 8.41421 8.66421 8.75 8.25 8.75H4.31812C3.9102 8.75 3.54317 8.99777 3.39065 9.37611L2.05831 12.6811C1.95744 12.9314 1.99873 13.2165 2.16646 13.4278C2.33418 13.6391 2.60248 13.7441 2.86908 13.7027C7.23525 13.0242 11.2273 11.2161 14.5368 8.58762C14.7159 8.44534 14.8204 8.22908 14.8204 8.00032C14.8204 7.77155 14.7159 7.55529 14.5368 7.41302C11.2273 4.78455 7.23525 2.97644 2.86908 2.29797Z" fill="currentColor"/>
</svg>
`
	};
</script>

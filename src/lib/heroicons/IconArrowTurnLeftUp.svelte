<script lang="ts">
	...
	export const NAME = `IconArrowTurnLeftUp`;

	const SVGS: Record<IconTheme, string> = {
		outline: `<svg data-type="svelte-heroicons" data-icon="IconArrowTurnLeftUp" data-theme="outline" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		solid: `<svg data-type="svelte-heroicons" data-icon="IconArrowTurnLeftUp" data-theme="solid" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		mini: `<svg data-type="svelte-heroicons" data-icon="IconArrowTurnLeftUp" data-theme="mini" aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M16 16.25C16 15.8358 15.6642 15.5 15.25 15.5H7.75L7.75 4.56066L9.71967 6.53033C10.0126 6.82322 10.4874 6.82322 10.7803 6.53033C11.0732 6.23744 11.0732 5.76256 10.7803 5.46967L7.53033 2.21967C7.23744 1.92678 6.76256 1.92678 6.46967 2.21967L3.21967 5.46967C2.92678 5.76256 2.92678 6.23744 3.21967 6.53033C3.51256 6.82322 3.98744 6.82322 4.28033 6.53033L6.25 4.56066L6.25 16.25C6.25 16.6642 6.58579 17 7 17H15.25C15.6642 17 16 16.6642 16 16.25Z" fill="currentColor"/>
</svg>
`,
		micro: `<svg data-type="svelte-heroicons" data-icon="IconArrowTurnLeftUp" data-theme="micro" aria-hidden="true" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M14 13.25C14 12.8358 13.6642 12.5 13.25 12.5H6.75L6.75 4.56066L7.71967 5.53033C8.01256 5.82322 8.48744 5.82322 8.78033 5.53033C9.07322 5.23744 9.07322 4.76256 8.78033 4.46967L6.53033 2.21967C6.23744 1.92678 5.76256 1.92678 5.46967 2.21967L3.21967 4.46967C2.92678 4.76256 2.92678 5.23744 3.21967 5.53033C3.51256 5.82322 3.98744 5.82322 4.28033 5.53033L5.25 4.56066L5.25 13.25C5.25 13.6642 5.58579 14 6 14H13.25C13.6642 14 14 13.6642 14 13.25Z" fill="currentColor"/>
</svg>
`
	};
</script>

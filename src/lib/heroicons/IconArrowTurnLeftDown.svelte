<script lang="ts">
	...
	export const NAME = `IconArrowTurnLeftDown`;

	const SVGS: Record<IconTheme, string> = {
		outline: `<svg data-type="svelte-heroicons" data-icon="IconArrowTurnLeftDown" data-theme="outline" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		solid: `<svg data-type="svelte-heroicons" data-icon="IconArrowTurnLeftDown" data-theme="solid" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
		mini: `<svg data-type="svelte-heroicons" data-icon="IconArrowTurnLeftDown" data-theme="mini" aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M16 3.75C16 4.16421 15.6642 4.5 15.25 4.5L7.75 4.5L7.75 15.4393L9.71967 13.4697C10.0126 13.1768 10.4874 13.1768 10.7803 13.4697C11.0732 13.7626 11.0732 14.2374 10.7803 14.5303L7.53033 17.7803C7.23744 18.0732 6.76256 18.0732 6.46967 17.7803L3.21967 14.5303C2.92678 14.2374 2.92678 13.7626 3.21967 13.4697C3.51256 13.1768 3.98744 13.1768 4.28033 13.4697L6.25 15.4393L6.25 3.75C6.25 3.33579 6.58579 3 7 3L15.25 3C15.6642 3 16 3.33579 16 3.75Z" fill="currentColor"/>
</svg>
`,
		micro: `<svg data-type="svelte-heroicons" data-icon="IconArrowTurnLeftDown" data-theme="micro" aria-hidden="true" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M5.46967 2.21967C5.61032 2.07902 5.80109 2 6 2H13.25C13.6642 2 14 2.33579 14 2.75C14 3.16421 13.6642 3.5 13.25 3.5H6.75L6.75 11.4393L7.71967 10.4697C8.01256 10.1768 8.48744 10.1768 8.78033 10.4697C9.07322 10.7626 9.07322 11.2374 8.78033 11.5303L6.53033 13.7803C6.23744 14.0732 5.76256 14.0732 5.46967 13.7803L3.21967 11.5303C2.92678 11.2374 2.92678 10.7626 3.21967 10.4697C3.51256 10.1768 3.98744 10.1768 4.28033 10.4697L5.25 11.4393L5.25 2.75C5.25 2.55109 5.32902 2.36032 5.46967 2.21967Z" fill="currentColor"/>
</svg>
`
	};
</script>
